    ...
    <div x-data="{ sidebarOpen: true }" class="flex h-screen bg-gray-100">
        ...
        <div x-show="sidebarOpen" x-cloak
            ...
            <div class="flex items-center justify-center h-16 bg-gray-100">
                                                ...
                                                <a href="{{ route('dashboard') }}" class="flex items-center text-gray-800 text-2xl font-semibold tracking-wider uppercase">
            ...
            <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-primary">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative mx-4 lg:mx-0">
                        ...
                        <input class="form-input w-32 pl-10 pr-4 rounded-md sm:w-64 focus:border-green-500" type="text"
