    ...
    <div class="mb-4">
        <div class="relative">
            ...
            <input wire:model.live.debounce.300ms="search" type="text"
                placeholder="Search participants by name, email, company..."
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($participants as $participant)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $participant->company }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $participant->department }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $participant->address }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <a href="{{ route('master.external-participants.edit', $participant->id) }}"
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="text-center py-12">
                                ...
                                <div class="mt-6">
                                    <a href="{{ route('master.external-participants.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
        ...
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md m-4" @click.away="show = false">
            <div class="flex items-start">
                ...
                <div class="ml-4 text-left">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">Are you sure you want to delete this participant? This action cannot be undone.</p>
                    </div>
                </div>
            </div>
